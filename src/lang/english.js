...
export const english = {
  ...
  Dashboard: {
    ...
    payment: {
      ...
      info:
        "once payment is done send notification to live support or email support to support@reliancexchange.co. in order to notify us of your successful deposit",
      copy: "copied",
    },
    tabs: {
      account: "Account",
